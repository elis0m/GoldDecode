...
function renderChart(history, period, unit) {
  ...
  s += `<circle cx="${minX.toFixed(1)}" cy="${minY.toFixed(1)}" r="4" fill="none" stroke="${gold}" stroke-width="2"/>`;
  ...
  s += `<circle cx="${maxX.toFixed(1)}" cy="${maxY.toFixed(1)}" r="4" fill="none" stroke="${gold}" stroke-width="2"/>`;
  ...
  s += `<circle id="ct-dot" r="4.5" style="fill:${gold};stroke-width:2;display:none"/>`;
